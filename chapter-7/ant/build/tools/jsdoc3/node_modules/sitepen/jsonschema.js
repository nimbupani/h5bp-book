...
var validate = exports._validate = function( /*Any*/ instance, /*Object*/ schema, /*Boolean*/ _changing) {
  ...
  function checkProp(value, schema, path, i) {
    ...
    function checkType(type, value) {
      if (type) {
        if (typeof type == 'string' && type != 'any' &&
          (type == 'null' ? value !== null : typeof value != type) && !(value instanceof Array && type == 'array') && !(type == 'integer' && value % 1 === 0)) {
          return [{
            property: path,
        ...
        if (type instanceof Array) {
          ...
          for (var j = 0; j < type.length; j++) { // a union type
            if (!(unionErrors = checkType(type[j], value))
              .length) {
              break;
            }
          }
    ...
    if (value === undefined) {
      ...
      if (schema.disallow && !checkType(schema.disallow, value)
        .length) {
