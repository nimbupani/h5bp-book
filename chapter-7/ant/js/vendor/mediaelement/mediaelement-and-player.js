...
mejs.MediaFeatures = {
  init: function() {
    ...
    t.isIE = (nav.appName.toLowerCase()
      .indexOf("microsoft") != -1);
...
mejs.HtmlMediaElementShim = {
  ...
  determinePlayback: function(htmlMediaElement, options, supportsMediaTag, isMediaTag, src) {
    ...
    if (!isMediaTag && mediaFiles.length > 0 && mediaFiles[0].url !== null && this.getTypeFromFile(mediaFiles[0].url)
      .indexOf('audio') > -1) {
    ...
    if (supportsMediaTag && (options.mode === 'auto' || options.mode === 'native')) {
      ...
      for (i = 0; i < mediaFiles.length; i++) {
        // normal check
        if (htmlMediaElement.canPlayType(mediaFiles[i].type)
          .replace(/no/, '') !== ''
    ...
    init: function() {
      ...
      if ((mf.isiPad && t.options.iPadUseNativeControls) || (mf.isiPhone && t.options.iPhoneUseNativeControls)) {
        ...
        if (mf.isiOS) {
          ...
          t.container.find('.mejs-mediaelement')
            .append($newMedia);
        ...
        var capsTagName = tagName.substring(0, 1)
          .toUpperCase() + tagName.substring(1);

        if (t.options[tagName + 'Width'] > 0 || t.options[tagName + 'Width'].toString()
          .indexOf('%') > -1) {
        ...
        if (t.options[tagName + 'Height'] > 0 || t.options[tagName + 'Height'].toString()
          .indexOf('%') > -1) {
    ...
    setPlayerSize: function(width, height) {
      ...
      if (t.height.toString()
        ...
        nativeWidth = (t.media.videoWidth && t.media.videoWidth > 0) ? t.media.videoWidth : t.options.defaultVideoWidth,
          ...
          parentWidth = t.container.parent()
            .width(),
          ...
          .click(function() {
            ...
            if (media.currentTime > 0) {
              ...
              controls.find('.mejs-time-current')
                .width('0px');
              controls.find('.mejs-time-handle')
                .css('left', '0px');
              controls.find('.mejs-time-float-current')
                .html(mejs.Utility.secondsToTimeCode(0));
              controls.find('.mejs-currenttime')
                .html(mejs.Utility.secondsToTimeCode(0));
              layers.find('.mejs-poster')
                .show();
            }
          });
    }
    ...
    buildvolume: function(player, controls, layers, media) {
      ...
      var t = this,
        ...
        positionVolumeHandle = function(volume, secondTry) {
          ...
          if (volume == 0) {
            mute.removeClass('mejs-mute')
              .addClass('mejs-unmute');
          } else {
      ...
      if (t.media.pluginType === 'native' || (!t.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)) {
        ...
        if (supportsPointerEvents && !mejs.MediaFeatures.isOpera) { // opera doesn't allow this :(
          ...
          var fullscreenIsDisabled = false,
            ...
            videoHoverDiv = $('<div class="mejs-fullscreen-hover" />')
              .appendTo(t.container)
              .mouseover(restoreControls),
            controlsLeftHoverDiv = $('<div class="mejs-fullscreen-hover"  />')
              .appendTo(t.container)
              .mouseover(restoreControls),
            controlsRightHoverDiv = $('<div class="mejs-fullscreen-hover"  />')
              .appendTo(t.container)
              .mouseover(restoreControls),
            positionHoverDivs = function() {
              ...
              var fullScreenBtnOffset = fullscreenBtn.offset()
                .left - t.container.offset()
                .left;
...
(function($) {
  ...
  $.extend(MediaElementPlayer.prototype, {
        ...
        function() {
          ...
          if (player.hasChapters) {
            ...
            player.chapters.fadeIn(200)
              .height(player.chapters.find('.mejs-chapter')
                .outerHeight());
          }
        },
        function() {
    ...
    addTrackButton: function(lang, label) {
      ...
      t.container.find('.mejs-captions-translations option[value=' + lang + ']')
        .remove();
    },
    ...
    adjustLanguageBox: function() {
      ...
      t.captionsButton.find('.mejs-captions-selector')
        .height(
          t.captionsButton.find('.mejs-captions-selector ul')
          .outerHeight(true) +
          t.captionsButton.find('.mejs-captions-translations')
          .outerHeight(true)
      );
    },
    ...
    drawChapters: function(chapters) {
      ...
      t.chapters.find('div.mejs-chapter')
        .click(function() {
          t.media.setCurrentTime(parseFloat($(this)
            .attr('rel')));
          if (t.media.paused) {
            t.media.play();
          }
...
(function($) {
  ...
  $.extend(MediaElementPlayer.prototype, {
    ...
    renderContextMenu: function(x, y) {
      ...
      // bind events
      t.contextMenu.find('.mejs-contextmenu-item')
        .each(function() {
