...
(function(expose) {
      ...
      lists: (function() {
        ...
        return function(block, next) {
          ...
          function make_list(m) {
            var list = bullet_list(m[2]) ? ["bulletlist"] : ["numberlist"];
    ...
    __call__: function inline(text, patterns) {
      ...
      while ((m = re.exec(text)) != null) {
        if (m[1]) add(m[1]); // Some un-interesting text matched
          ...
          length: 0
        }; // Or there was none, but make m[1].length == 0
  ...
  function extract_attr(jsonml) {
    return jsonml instanceof Array && jsonml.length > 1 && typeof jsonml[1] === "object" && !(jsonml[1] instanceof Array) ? jsonml[1] : undefined;
  }
